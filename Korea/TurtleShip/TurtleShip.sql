...
VALUES		('PROMOTION_UNIT_KOREA_COAST_MOVE',	'TXT_KEY_PROMOTION_UNIT_KOREA_COAST_MOVE',		'TXT_KEY_PROMOTION_UNIT_KOREA_COAST_MOVE_HELP',	'AS2D_IF_LEVELUP',	44,				1,				'PROMOTION_ATLAS', 'PEDIA_NAVAL',	'TXT_KEY_PROMOTION_UNIT_KOREA_COAST_MOVE'),
			('PROMOTION_UNIT_KOREA_DECK_SPIKES',	'TXT_KEY_PROMOTION_UNIT_KOREA_DECK_SPIKES',	'TXT_KEY_PROMOTION_UNIT_KOREA_DECK_SPIKES_HELP',	'AS2D_IF_LEVELUP',	25,				1,				'PROMOTION_ATLAS', 'PEDIA_NAVAL',	'TXT_KEY_PROMOTION_UNIT_KOREA_DECK_SPIKES');
