...
VALUES		('PROMOTION_UNIT_KOREA_COAST_MOVE',		'TXT_KEY_PROMOTION_UNIT_KOREA_COAST_MOVE',	'TXT_KEY_PROMOTION_UNIT_KOREA_COAST_MOVE_HELP',		'AS2D_IF_LEVELUP',	57,				1,				'promoMUC_atlas_00', 	'PEDIA_NAVAL',	'TXT_KEY_PROMOTION_UNIT_KOREA_COAST_MOVE'),
			('PROMOTION_UNIT_KOREA_DECK_SPIKES',	'TXT_KEY_PROMOTION_UNIT_KOREA_DECK_SPIKES',	'TXT_KEY_PROMOTION_UNIT_KOREA_DECK_SPIKES_HELP',	'AS2D_IF_LEVELUP',	58,				1,				'promoMUC_atlas_00', 	'PEDIA_NAVAL',	'TXT_KEY_PROMOTION_UNIT_KOREA_DECK_SPIKES');
