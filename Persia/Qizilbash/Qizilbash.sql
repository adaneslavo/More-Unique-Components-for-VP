...
VALUES		('UNIT_PERSIA_ATLAS', 				256, 		'QizilbashPicture_256.dds',			1, 				1),
			...
			('UNIT_PERSIA_PROMOTION_ATLAS',		256, 		'SafaviAgitatorIcon_256.dds',		1, 				1);
--==========================================================================================================================	
...
SELECT		'UNIT_PERSIA_QIZILBASH',	Class,	PrereqTech,	Range,	BaseSightRange, Combat+5,	Cost,	FaithCost-50,	0,								1,								Moves, Immobile, CombatClass, Domain, DefaultUnitAI,	'TECH_COMBINED_ARMS',	GoodyHutUpgradeUnitClass,	XPValueAttack,	IsMounted,	'TXT_KEY_UNIT_PERSIA_QIZILBASH',	'TXT_KEY_UNIT_PERSIA_QIZILBASH_TEXT',	'TXT_KEY_UNIT_PERSIA_QIZILBASH_STRATEGY',	'TXT_KEY_UNIT_PERSIA_QIZILBASH_HELP',	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AirUnitCap, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_PERSIA_QIZILBASH', 	0,					'UNIT_PERSIA_FLAG_ATLAS',	0, 				'UNIT_PERSIA_ATLAS',	MoveRate
