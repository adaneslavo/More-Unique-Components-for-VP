...
VALUES		('PROMOTION_UNIT_NETHERLANDS_GOEDENDAG',			'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG',				'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG_HELP',				'AS2D_IF_LEVELUP',	0,				0,				0,			0,			0,					0,					0, 					1,				25, 			'PROMOTION_ATLAS', 	'PEDIA_MELEE',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG'),
			...
			('PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_EFFECT',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_EFFECT',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_EFFECT_HELP',		'AS2D_IF_LEVELUP',	50,				0,				0,			0,			0,					0,					0, 					1,				35, 			'PROMOTION_ATLAS', 	'PEDIA_MELEE',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_EFFECT');
------------------------------
