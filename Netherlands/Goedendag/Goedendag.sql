...
SELECT		Class,		'UNIT_NETHERLANDS_GOEDENDAG', 	PrereqTech, 'TECH_RIFLING',	RangedCombat, Range,	AirInterceptRange, Special, Combat+1, 	Cost-35, 	FaithCost, RequiresFaithPurchaseEnabled, Moves, Immobile, CombatClass, Domain, DefaultUnitAI, GoodyHutUpgradeUnitClass,	XPValueAttack,	'TXT_KEY_UNIT_NETHERLANDS_GOEDENDAG', 	'TXT_KEY_UNIT_NETHERLANDS_GOEDENDAG_TEXT', 	'TXT_KEY_UNIT_NETHERLANDS_GOEDENDAG_STRATEGY', 	'TXT_KEY_UNIT_NETHERLANDS_GOEDENDAG_HELP', 		Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AirUnitCap, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 1,		'ART_DEF_UNIT_NETHERLANDS_GOEDENDAG', 	0, 					'UNIT_NETHERLANDS_FLAG_ATLAS', 	0, 				'UNIT_NETHERLANDS_ATLAS', 	MoveRate
...
VALUES		('PROMOTION_UNIT_NETHERLANDS_GOEDENDAG',			'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG',				'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG_HELP',				'AS2D_IF_LEVELUP',	0,				0,				0,			0,			0,					0,					0, 					1,				25, 			'PROMOTION_ATLAS', 	'PEDIA_MELEE',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG'),
			('PROMOTION_UNIT_NETHERLANDS_GOEDENDAG_EFFECT',		'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG_EFFECT',		'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG_EFFECT_HELP',			'AS2D_IF_LEVELUP',	10,				0,				0,			0,			0,					0,					0, 					1,				24, 			'PROMOTION_ATLAS', 	'PEDIA_MELEE',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_GOEDENDAG_EFFECT'),
			('PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE',			'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE',			'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_HELP',				'AS2D_IF_LEVELUP',	0,				0,				0,			0,			0,					0,					0, 					1,				35, 			'PROMOTION_ATLAS', 	'PEDIA_MELEE',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE'),
			('PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_EFFECT',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_EFFECT',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_EFFECT_HELP',		'AS2D_IF_LEVELUP',	25,				0,				0,			0,			0,					0,					0, 					1,				35, 			'PROMOTION_ATLAS', 	'PEDIA_MELEE',	'TXT_KEY_PROMOTION_UNIT_NETHERLANDS_BURGEMEESTE_EFFECT');
------------------------------
