...
function YamatoOnBuild(iPlayer, iCity, iUnit)
	...
	if pUnit:GetUnitType() == GameInfoTypes.UNIT_JAPAN_YAMATO then
		...
		if pPlayer:IsHuman() and pPlayer:IsTurnActive() then
			pPlayer:AddNotification(
				...
				pUnit:GetX(), pUnit:GetY(), GameInfoTypes.UNIT_JAPAN_YAMATO)
		end
	end
end
...
function YamatoOnDeath(iPlayerKiller, iPlayerKillee, eKillerUnitType, eKilledUnitType)
	...
	if eKilledUnitType == GameInfoTypes.UNIT_JAPAN_YAMATO then
