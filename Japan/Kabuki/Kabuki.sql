...
INSERT INTO	Buildings
		(Type, 							Description, 							Civilopedia, 								Strategy, 										Help, 										GreatPeopleRateChange,   SpecialistCount, SpecialistType, NoUnhappfromXSpecialists, GreatWorkSlotType, GreatWorkCount, GoldMaintenance, Cost, HurryCostModifier, MinAreaSize, ConquestProb, BuildingClass, ArtDefineTag, PrereqTech, PortraitIndex, 	IconAtlas, NeverCapture)
SELECT	'BUILDING_JAPAN_MONOGATARI', 	'TXT_KEY_BUILDING_JAPAN_MONOGATARI', 	'TXT_KEY_BUILDING_JAPAN_MONOGATARI_TEXT',  	'TXT_KEY_BUILDING_JAPAN_MONOGATARI_STRATEGY', 	'TXT_KEY_BUILDING_JAPAN_MONOGATARI_HELP', 	GreatPeopleRateChange+2, SpecialistCount, SpecialistType, NoUnhappfromXSpecialists, GreatWorkSlotType, GreatWorkCount, GoldMaintenance, Cost, HurryCostModifier, MinAreaSize, ConquestProb, BuildingClass, ArtDefineTag, PrereqTech, 0, 				'JAPGUILDS_ATLAS', NeverCapture
FROM	Buildings
