...
SELECT		'BUILDING_RANCH',	'TXT_KEY_BUILDING_RANCH',	'TXT_KEY_BUILDING_RANCH',	'TXT_KEY_BUILDING_RANCH_STRATEGY',	'TXT_KEY_BUILDING_RANCH_HELP',	GoldMaintenance, Cost, HurryCostModifier, MinAreaSize, ConquestProb,BuildingClass, ArtDefineTag, PrereqTech, 0,				'3UC_RANCH_ICON_ATLAS', GreatWorkYieldType, CitySupplyModifier, PlotCultureCostModifier-25
...
VALUES		('BUILDING_RANCH',	'RESOURCE_HORSE',	'YIELD_FOOD',			2),
			('BUILDING_RANCH',	'RESOURCE_HORSE',	'YIELD_GOLD',			2),
			('BUILDING_RANCH',	'RESOURCE_COW',		'YIELD_FOOD',			2),
			('BUILDING_RANCH',	'RESOURCE_COW',		'YIELD_GOLD',			2),
			('BUILDING_RANCH',	'RESOURCE_SHEEP',	'YIELD_FOOD',			2),
			('BUILDING_RANCH',	'RESOURCE_SHEEP',	'YIELD_GOLD',			2),
			('BUILDING_RANCH',	'RESOURCE_BISON',	'YIELD_PRODUCTION',		2),
			('BUILDING_RANCH',	'RESOURCE_BISON',	'YIELD_FOOD',			2),
			('BUILDING_RANCH',	'RESOURCE_BISON',	'YIELD_GOLD',			2);
--------------------------------
