...
VALUES		('PROMOTION_UNIT_ARABIA_GARLAND_MINE',	'TXT_KEY_PROMOTION_UNIT_ARABIA_GARLAND_MINE',	'TXT_KEY_PROMOTION_UNIT_ARABIA_GARLAND_MINE_HELP',	1,				'AS2D_IF_LEVELUP',	3,				'promoMUC_atlas_00',	'PEDIA_RANGED',	'TXT_KEY_PROMOTION_UNIT_ARABIA_GARLAND_MINE',	1),
			('PROMOTION_UNIT_ARABIA_DESERT_RAIDER',	'TXT_KEY_PROMOTION_UNIT_ARABIA_DESERT_RAIDER',	'TXT_KEY_PROMOTION_UNIT_ARABIA_DESERT_RAIDER_HELP',	1,				'AS2D_IF_LEVELUP',	2,				'promoMUC_atlas_00',	'PEDIA_RANGED',	'TXT_KEY_PROMOTION_UNIT_ARABIA_DESERT_RAIDER',	0);
--------------------------------
