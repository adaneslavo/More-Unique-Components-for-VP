...
INSERT INTO Buildings 	
			(Type,						BuildingClass,						CivilizationRequired,	CityConnectionGoldModifier,	GoldMaintenance, Cost,	FaithCost,	EnhancedYieldTech, TechEnhancedTourism, AllowsRangeStrike, Defense,	ExtraCityHitPoints, TrainedFreePromotion,	CitySupplyFlat,	DefenseHappinessChange, GreatPeopleRateModifier, GreatWorkSlotType, GreatWorkCount, FreshWater, FreeStartEra, Happiness, NeverCapture, PrereqTech,		ArtDefineTag, MinAreaSize, ConquestProb, HurryCostModifier,	Help,									Description,						IconAtlas,					PortraitIndex)
SELECT		'BUILDING_RUSSIA_POGOST_2',	'BUILDINGCLASS_RUSSIA_POGOST_2',	'CIVILIZATION_RUSSIA',	10,									0,				-1,		-1,			EnhancedYieldTech, TechEnhancedTourism, AllowsRangeStrike, Defense,	ExtraCityHitPoints, TrainedFreePromotion,	CitySupplyFlat,	DefenseHappinessChange,	GreatPeopleRateModifier, GreatWorkSlotType, GreatWorkCount, FreshWater, FreeStartEra, Happiness, NeverCapture, 'TECH_BANKING',	ArtDefineTag, MinAreaSize, ConquestProb, HurryCostModifier,	'TXT_KEY_BUILDING_RUSSIA_POGOST_2_HELP',	'TXT_KEY_BUILDING_RUSSIA_POGOST_2',	'BUILDING_RUSSIA2_ATLAS',	0
