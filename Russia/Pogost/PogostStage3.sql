...
INSERT INTO Buildings 	
			(Type,						BuildingClass,						CityConnectionGoldModifier, 	CivilizationRequired,	GoldMaintenance, Cost,	FaithCost,	EnhancedYieldTech, TechEnhancedTourism, AllowsRangeStrike, Defense,	ExtraCityHitPoints, TrainedFreePromotion,	CitySupplyFlat,	DefenseHappinessChange, GreatPeopleRateModifier, GreatWorkSlotType, GreatWorkCount, FreshWater, FreeStartEra, Happiness, NeverCapture, PrereqTech,			ArtDefineTag, MinAreaSize, ConquestProb, HurryCostModifier,	Help,									Description,						IconAtlas,					PortraitIndex)
SELECT		'BUILDING_RUSSIA_POGOST_3',	'BUILDINGCLASS_RUSSIA_POGOST_3',	10, 									'CIVILIZATION_RUSSIA',	0,				-1,		-1,			EnhancedYieldTech, TechEnhancedTourism, AllowsRangeStrike, Defense,	ExtraCityHitPoints, TrainedFreePromotion,	CitySupplyFlat,	DefenseHappinessChange,	GreatPeopleRateModifier, GreatWorkSlotType, GreatWorkCount, FreshWater, FreeStartEra, Happiness, NeverCapture, 'TECH_ARCHITECTURE', ArtDefineTag, MinAreaSize, ConquestProb, HurryCostModifier,	'TXT_KEY_BUILDING_RUSSIA_POGOST_3_HELP',	'TXT_KEY_BUILDING_RUSSIA_POGOST_3',	'BUILDING_RUSSIA3_ATLAS',	0
