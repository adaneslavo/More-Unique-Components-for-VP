...
SELECT		'UNIT_INDONESIA_DJONG',	'TXT_KEY_UNIT_INDONESIA_DJONG',	'TXT_KEY_UNIT_INDONESIA_DJONG_TEXT',	'TXT_KEY_UNIT_INDONESIA_DJONG_STRATEGY',	'TXT_KEY_UNIT_INDONESIA_DJONG_HELP', 	Combat+1,	RangedCombat+1, Cost+25, 	FaithCost, RequiresFaithPurchaseEnabled, Moves, 2, 		BaseSightRange, Class, CombatClass, Domain, DefaultUnitAI, MilitarySupport, MilitaryProduction, Pillage, IgnoreBuildingDefense, Mechanized, PrereqTech,	'TECH_DYNAMITE', 	GoodyHutUpgradeUnitClass, HurryCostModifier, AdvancedStartCost, MinAreaSize, Conscription, XPValueAttack, XPValueDefense, 'ART_DEF_UNIT_DJONG', 	0,					0,				'UNIT_INDONESIA_ATLAS',	'UNIT_INDONESIA_FLAG_ATLAS',	MoveRate, PurchaseCooldown, BaseLandAirDefense, IsMounted
