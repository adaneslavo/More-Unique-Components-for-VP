...
function IronChariotResourceCheck(iPlayer)
	...
	for unit in pPlayer:Units() do
		if (unit:GetUnitType() == GameInfoTypes.UNIT_ASSYRIA_IRON_CHARIOT) then
...
function FuryOfNergalUpdate(pPlayer, unit)
	unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_1, false)
	unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_2, false)
	unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_3, false)
	unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_4, false)
	unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_5, false)
	unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_6, false)
	...
	if (numEnemyUnitsNearby == 1) then
		unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_1, true)
	elseif (numEnemyUnitsNearby == 2) then
		unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_2, true)
	elseif (numEnemyUnitsNearby == 3) then
		unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_3, true)
	elseif (numEnemyUnitsNearby == 4) then
		unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_4, true)
	elseif (numEnemyUnitsNearby == 5) then
		unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_5, true)
	elseif (numEnemyUnitsNearby == 6) then
		unit:SetHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL_6, true)
	end
end
...
function FuryOfNergalCheckTurnStart(iPlayer)
	pPlayer = Players[iPlayer]
	for unit in pPlayer:Units() do
		if unit:IsHasPromotion(GameInfoTypes.PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL) then
