...
SELECT		'UNIT_ASSYRIA_IRON_CHARIOT',	'TXT_KEY_UNIT_ASSYRIA_IRON_CHARIOT',	'TXT_KEY_UNIT_ASSYRIA_IRON_CHARIOT_TEXT',	'TXT_KEY_UNIT_ASSYRIA_IRON_CHARIOT_STRATEGY',	'TXT_KEY_UNIT_ASSYRIA_IRON_CHARIOT_HELP', 	Combat-2,	RangedCombat, Cost, FaithCost, RequiresFaithPurchaseEnabled, Moves, Range, BaseSightRange, Class, CombatClass, Domain,	DefaultUnitAI,  MilitarySupport, MilitaryProduction, Pillage, IgnoreBuildingDefense, Mechanized, 'TECH_IRON_WORKING', 	'TECH_METALLURGY', GoodyHutUpgradeUnitClass, HurryCostModifier, AdvancedStartCost, MinAreaSize, Conscription, XPValueAttack, XPValueDefense, 'ART_DEF_UNIT_TCM_HEQA_KHASUT', 	0,					0,				'UNIT_ASSYRIA_ATLAS',	'UNIT_ASSYRIA_FLAG_ATLAS',	MoveRate, PurchaseCooldown, BaseLandAirDefense, IsMounted
...
VALUES			('UNIT_ASSYRIA_IRON_CHARIOT',	'PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL'),
				...
				('UNIT_ASSYRIA_IRON_CHARIOT',	'PROMOTION_ROUGH_TERRAIN_ENDS_TURN');
--==========================================================================================================================	
...
VALUES
	('PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL', 'UNITCOMBAT_RECON', 7, 0, 0),
	('PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL', 'UNITCOMBAT_ARCHER', 7, 0, 0),
	('PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL', 'UNITCOMBAT_MELEE', 7, 0, 0),
	('PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL', 'UNITCOMBAT_SIEGE', 7, 0, 0),
	('PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL', 'UNITCOMBAT_GUN', 7, 0, 0),
	('PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL', 'UNITCOMBAT_HELICOPTER', 7, 0, 0),
	('PROMOTION_UNIT_ASSYRIA_FURY_OF_NERGAL', 'UNITCOMBAT_ARMOR', 7, 0, 0);
