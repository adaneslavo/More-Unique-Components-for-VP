...
SELECT	'UNIT_3UC_SOFA',	Class,	PrereqTech, 20, Range, Special, 12, 130, 'TECH_DYNAMITE', GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain,  DefaultUnitAI,  'TXT_KEY_UNIT_3UC_SOFA_HELP', 'TXT_KEY_UNIT_3UC_SOFA',  'TXT_KEY_UNIT_3UC_SOFA_TEXT',	'TXT_KEY_UNIT_3UC_SOFA_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_SOFA',	0,					'UNIT_ALPHA_SOFA_ATLAS',					  0, 				'SOFA_ATLAS',	 MoveRate
