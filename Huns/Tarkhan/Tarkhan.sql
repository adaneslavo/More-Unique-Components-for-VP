...
SELECT	'UNIT_HUNS_TARKHAN',	Class,	PrereqTech, Special, Combat, Cost-5,	'TECH_METALLURGY',	GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain,  DefaultUnitAI,  'TXT_KEY_UNIT_HUNS_TARKHAN_HELP', 	'TXT_KEY_UNIT_HUNS_TARKHAN',	'TXT_KEY_UNIT_HUNS_TARKHAN_TEXT',	'TXT_KEY_UNIT_HUNS_TARKHAN_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_HUNS_TARKHAN',	0,					'UNIT_HUNS_FLAG_ATLAS',	0, 				'UNIT_HUNS_ATLAS',	MoveRate
