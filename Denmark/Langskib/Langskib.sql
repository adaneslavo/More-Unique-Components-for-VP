...
SELECT		Class,		'UNIT_DENMARK_LANGSKIB', 	'TECH_PHYSICS', Range,	AirInterceptRange, Special, BaseSightRange, Combat-3, 	Cost-40,	FaithCost, 	RequiresFaithPurchaseEnabled, 	Moves, Immobile, CombatClass, Domain, DefaultUnitAI, 	'TECH_INDUSTRIALIZATION',	GoodyHutUpgradeUnitClass,	XPValueAttack,	'TXT_KEY_UNIT_DENMARK_LANGSKIB', 	'TXT_KEY_UNIT_DENMARK_LANGSKIB_TEXT', 	'TXT_KEY_UNIT_DENMARK_LANGSKIB_STRATEGY', 	'TXT_KEY_UNIT_DENMARK_LANGSKIB_HELP', 	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AirUnitCap, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_DENMARK_LANGSKIB', 	0,					'UNIT_DENMARK_FLAG_ATLAS',	0, 				'UNIT_DENMARK_ATLAS',		MoveRate
...
VALUES		('UNIT_DENMARK_LANGSKIB', 		'PROMOTION_UNIT_DENMARK_VIKING_EXPLORATION'),
			('UNIT_DENMARK_LANGSKIB', 		'PROMOTION_MEDIC'),
