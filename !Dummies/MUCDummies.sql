...
VALUES		('BUILDING_D_FOR_BARBICAN',		'BUILDINGCLASS_ARMORY',				'TXT_KEY_BUILDING_D_FOR_BARBICAN',		0,					-1,		-1,			-1,				1,				1,			0,				-1,					'CIV_COLOR_ATLAS',	0, 0),
			...
			('BUILDING_D_FOR_BUFFALO',		'BUILDINGCLASS_D_FOR_BUFFALO',		'TXT_KEY_BUILDING_D_FOR_BUFFALO',		0,					-1,		-1,			-1,				0,				1,			100,				-1,					'CIV_COLOR_ATLAS',	0, 0),
			('BUILDING_D_FOR_FLAX',			'BUILDINGCLASS_D_FOR_FLAX',		'TXT_KEY_BUILDING_D_FOR_FLAX',			0,					-1,		-1,			-1,				0,				1,			100,				-1,					'CIV_COLOR_ATLAS',	0, 0),
