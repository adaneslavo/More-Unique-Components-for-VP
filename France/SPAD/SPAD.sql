...
SELECT		'UNIT_FRANCE_SPAD',	Class,	PrereqTech,	Range,	BaseSightRange, RangedCombat-5,	Combat+20, Cost,	FaithCost,	RequiresFaithPurchaseEnabled,	Moves, Immobile, CombatClass, Domain, DefaultUnitAI,	'TECH_LASERS',		GoodyHutUpgradeUnitClass,	XPValueAttack,	AirInterceptRange+1,	'TXT_KEY_UNIT_FRANCE_SPAD',	'TXT_KEY_UNIT_FRANCE_SPAD_TEXT',	'TXT_KEY_UNIT_FRANCE_SPAD_STRATEGY',	'TXT_KEY_UNIT_FRANCE_SPAD_HELP',	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AirUnitCap, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, IsMounted,	'ART_DEF_UNIT_FRANCE_SPAD', 	0,					'UNIT_FRANCE_FLAG_ATLAS',	0, 				'UNIT_FRANCE_ATLAS',	MoveRate,	Special, 	PurchaseCooldown
