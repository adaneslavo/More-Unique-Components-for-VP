...
VALUES		('UNIT_OTTOMANS_GREAT_TURKISH_BOMBARD', 'PROMOTION_UNIT_OTTOMANS_SIEGE_INACCURACY_2'),
			...
			('UNIT_OTTOMANS_GREAT_TURKISH_BOMBARD', 'PROMOTION_CITY_SIEGE_II');
--------------------------------
