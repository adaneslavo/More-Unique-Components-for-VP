...
VALUES		('BUILDING_OTTOMANS_TERSANE',	'RESOURCE_FISH',	'YIELD_PRODUCTION',	1),
			('BUILDING_OTTOMANS_TERSANE',	'RESOURCE_PEARLS',	'YIELD_PRODUCTION',	1),
			('BUILDING_OTTOMANS_TERSANE',	'RESOURCE_CRAB',	'YIELD_PRODUCTION',	1),
			('BUILDING_OTTOMANS_TERSANE',	'RESOURCE_WHALE',	'YIELD_PRODUCTION',	1),
			('BUILDING_OTTOMANS_TERSANE',	'RESOURCE_CORAL',	'YIELD_PRODUCTION',	1);
------------------------------	
