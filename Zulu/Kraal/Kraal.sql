...
INSERT INTO Improvements
			(Type, 						Description, 						Civilopedia, 							ArtDefineTag, 						Help, 									CultureBombRadius, 	MakesPassable, 	InAdjacentFriendly, PillageGold,	CreatedByGreatPerson,	BuildableOnResources,	SpecificCivRequired,	Permanent,	DestroyedWhenPillaged, 	PortraitIndex, 	IconAtlas, 			NoTwoAdjacent,	DefenseModifier, 	NearbyEnemyDamage, 	NoFollowUp)
VALUES		('IMPROVEMENT_ZULU_KRAAL',	'TXT_KEY_IMPROVEMENT_ZULU_KRAAL',	'TXT_KEY_IMPROVEMENT_ZULU_KRAAL_TEXT',	'ART_DEF_IMPROVEMENT_ZULU_KRAAL',	'TXT_KEY_IMPROVEMENT_ZULU_KRAAL_HELP',	1, 					1, 				1, 					17,				1,						1,						0, 						0,			0,						0,				'ZULU_KRAAL_ATLAS',	1,				100, 				30, 				1);
------------------------------	
-- Improvement_Flavors
------------------------------		
INSERT INTO Improvement_Flavors	
			(ImprovementType, 			FlavorType,				Flavor)
VALUES		('IMPROVEMENT_ZULU_KRAAL',	'FLAVOR_SCIENCE',		60),
			('IMPROVEMENT_ZULU_KRAAL',	'FLAVOR_PRODUCTION',	60),
			('IMPROVEMENT_ZULU_KRAAL',	'FLAVOR_CITY_DEFENSE',	20),
			('IMPROVEMENT_ZULU_KRAAL',	'FLAVOR_DEFENSE',		50);
------------------------------	
-- Improvement_Yields
------------------------------		
...
SELECT 	'IMPROVEMENT_ZULU_KRAAL', 		ResourceType, YieldType, Yield
