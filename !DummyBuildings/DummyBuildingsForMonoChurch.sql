...
VALUES		('BUILDING_ETHIOPIA_MONOLITHIC_CHURCH_TRADITION',	'IMPROVEMENT_ETHIOPIA_MONOLITHIC_CHURCH',	'YIELD_CULTURE',	1),
			...
			('BUILDING_ETHIOPIA_MONOLITHIC_CHURCH_RATIONALISM',	'IMPROVEMENT_ETHIOPIA_MONOLITHIC_CHURCH',	'YIELD_PRODUCTION',	1),
			('BUILDING_ETHIOPIA_MONOLITHIC_CHURCH_EXPLORATION',	'IMPROVEMENT_ETHIOPIA_MONOLITHIC_CHURCH',	'YIELD_SCIENCE',	1),
			('BUILDING_ETHIOPIA_MONOLITHIC_CHURCH_EXPLORATION',	'IMPROVEMENT_ETHIOPIA_MONOLITHIC_CHURCH',	'YIELD_PRODUCTION',	1),
			('BUILDING_ETHIOPIA_MONOLITHIC_CHURCH_COMMERCE',	'IMPROVEMENT_ETHIOPIA_MONOLITHIC_CHURCH',	'YIELD_SCIENCE',	1),
			('BUILDING_ETHIOPIA_MONOLITHIC_CHURCH_COMMERCE',	'IMPROVEMENT_ETHIOPIA_MONOLITHIC_CHURCH',	'YIELD_PRODUCTION',	1),
			('BUILDING_ETHIOPIA_MONOLITHIC_CHURCH_PANTHEON',	'IMPROVEMENT_ETHIOPIA_MONOLITHIC_CHURCH',	'YIELD_FAITH',		1),
			('BUILDING_ETHIOPIA_MONOLITHIC_CHURCH_FOUNDER',		'IMPROVEMENT_ETHIOPIA_MONOLITHIC_CHURCH',	'YIELD_FAITH',		1),
