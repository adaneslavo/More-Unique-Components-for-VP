...
SELECT		'BUILDING_DUMMYDEFENSE',	'BUILDINGCLASS_DUMMYDEFENSE',	0,					-1,		-1,			EnhancedYieldTech, TechEnhancedTourism, AllowsRangeStrike, 500,		ExtraCityHitPoints, TrainedFreePromotion,	CitySupplyFlat,	DefenseHappinessChange,	GreatWorkSlotType, -1,				FreshWater, FreeStartEra, 0,					0,			1,				PrereqTech, ArtDefineTag, GreatPeopleRateChange,	SpecialistType, SpecialistCount, MinAreaSize, ConquestProb, -1,					'TXT_KEY_BUILDING_DUMMYDEFENSE', 'CIV_COLOR_ATLAS',	0
...
VALUES		('BUILDING_DUMMYDEFENSE',	'FLAVOR_CITY_DEFENSE',	-999);
------------------------------	
-- Building_ClassesNeededInCity
------------------------------		
INSERT INTO Building_ClassesNeededInCity 	
		(BuildingType, 				BuildingClassType)
SELECT	'BUILDING_DUMMYDEFENSE',	BuildingClassType
...
SELECT		'BUILDING_DUMMYDEFENSE',	ResourceType, Cost
