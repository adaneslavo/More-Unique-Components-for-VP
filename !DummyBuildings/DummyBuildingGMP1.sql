...
SELECT		'BUILDING_DUMMYGMP1',	'BUILDINGCLASS_DUMMYGMP1',	0,					-1,		-1,			EnhancedYieldTech, TechEnhancedTourism, AllowsRangeStrike, 0,		0,					TrainedFreePromotion,	CitySupplyFlat,	DefenseHappinessChange,	GreatPeopleRateModifier,	GreatWorkSlotType, -1,				FreshWater, FreeStartEra, 0,					0,			1,				PrereqTech, ArtDefineTag, 2,						'SPECIALIST_MERCHANT',	SpecialistCount, MinAreaSize, ConquestProb, -1,					'TXT_KEY_BUILDING_DUMMYGMP', 	'CIV_COLOR_ATLAS',	0
...
VALUES		('BUILDING_DUMMYGMP1',	'FLAVOR_GREAT_PEOPLE',	-999);
------------------------------	
-- Building_ClassesNeededInCity
------------------------------		
INSERT INTO Building_ClassesNeededInCity 	
		(BuildingType, 			BuildingClassType)
SELECT	'BUILDING_DUMMYGMP1',	BuildingClassType
...
SELECT		'BUILDING_DUMMYGMP1',	ResourceType, Cost
