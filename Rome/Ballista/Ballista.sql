...
VALUES		('PROMOTION_UNIT_ROME_LEGATUS_LEGIONIS',				'TXT_KEY_PROMOTION_UNIT_ROME_LEGATUS_LEGIONIS',				'TXT_KEY_PROMOTION_UNIT_ROME_LEGATUS_LEGIONIS_HELP',				'AS2D_IF_LEVELUP',	0,		0,				0,				0,			0,			0,					0,					0, 					1,				17, 			'PROMOTION_ATLAS', 	'PEDIA_MELEE',	'TXT_KEY_PROMOTION_UNIT_ROME_LEGATUS_LEGIONIS'),
			('PROMOTION_UNIT_ROME_LEGATUS_LEGIONIS_ON_BALLISTA',	'TXT_KEY_PROMOTION_UNIT_ROME_LEGATUS_LEGIONIS_ON_BALLISTA',	'TXT_KEY_PROMOTION_UNIT_ROME_LEGATUS_LEGIONIS_ON_BALLISTA_HELP',	'AS2D_IF_LEVELUP',	0,		0,				0,				0,			0,			0,					0,					0, 					1,				33, 			'PROMOTION_ATLAS', 	'PEDIA_RANGED',	'TXT_KEY_PROMOTION_UNIT_ROME_LEGATUS_LEGIONIS_ON_BALLISTA'),
...
-- Language_en_US 
--------------------------------
UPDATE Language_en_US SET Text = '' WHERE Tag = 'TXT_KEY_UNIT_HELP_BALLISTA';
UPDATE Language_en_US SET Text = '' WHERE Tag = 'TXT_KEY_UNIT_ROMAN_BALLISTA_STRATEGY';