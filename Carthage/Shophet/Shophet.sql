...
INSERT INTO Units 	
		(ShowInPedia, 	Type, 							CivilianAttackPriority, NumFreeLux, Class, Cost, Moves, Special, SupplyCapBoost, MoveAfterPurchase,	Domain, DefaultUnitAI, Description,						Civilopedia,							Strategy,									Help,									AdvancedStartCost,	WorkRate, CombatLimit, DontShowYields, UnitArtInfoEraVariation, UnitArtInfo,  							UnitFlagIconOffset,	UnitFlagAtlas,				MoveRate, PortraitIndex, IconAtlas,						PurchaseCooldown, GlobalFaithPurchaseCooldown)
SELECT	0, 		'UNIT_CARTHAGE_SHOPHET_BOAT',	CivilianAttackPriority, NumFreeLux, Class, Cost, Moves, Special, SupplyCapBoost, MoveAfterPurchase,	Domain, DefaultUnitAI, 'TXT_KEY_UNIT_CARTHAGE_SHOPHET',	'TXT_KEY_UNIT_CARTHAGE_SHOPHET_TEXT',	'TXT_KEY_UNIT_CARTHAGE_SHOPHET_STRATEGY',	'TXT_KEY_UNIT_CARTHAGE_SHOPHET_HELP',	AdvancedStartCost, 	WorkRate, CombatLimit, DontShowYields, UnitArtInfoEraVariation, 'ART_DEF_UNIT_CARTHAGE_SHOPHET_BOAT',	0,					'UNIT_CARTHAGE_FLAG_ATLAS',	MoveRate, 0, 			 'UNIT_CARTHAGE_BOAT_ATLAS',	PurchaseCooldown, GlobalFaithPurchaseCooldown
