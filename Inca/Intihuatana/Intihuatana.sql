...
/*INSERT INTO	Buildings
			(Type,							Description,							Civilopedia,								Strategy,										Help,										GoldMaintenance,	Cost,		HurryCostModifier, MinAreaSize, ConquestProb,	BuildingClass, ArtDefineTag, PrereqTech, PortraitIndex, IconAtlas,				GreatWorkYieldType,			TrainedFreePromotion, SpecialistType, SpecialistCount,	GreatPeopleRateModifier,	PrereqTech)
SELECT		'BUILDING_INCA_INTIHUATANA',	'TXT_KEY_BUILDING_INCA_INTIHUATANA',	'TXT_KEY_BUILDING_INCA_INTIHUATANA_TEXT',	'TXT_KEY_BUILDING_INCA_INTIHUATANA_STRATEGY',	'TXT_KEY_BUILDING_INCA_INTIHUATANA_HELP',	0,					Cost-200,	HurryCostModifier, MinAreaSize, ConquestProb,	BuildingClass, ArtDefineTag, PrereqTech, 0,				'BUILDING_CHINA_ATLAS',	GreatWorkYieldType,			TrainedFreePromotion, SpecialistType, SpecialistCount,	GreatPeopleRateModifier,	'TECH_THEOLOGY'
