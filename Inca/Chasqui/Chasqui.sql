...
SELECT		'UNIT_INCA_CHASQUI',	Class,	NoBadGoodies, PrereqTech, RangedCombat, Range, Special, Combat, Cost, 'TECH_STEAM_POWER', 	GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_INCA_CHASQUI', 	'TXT_KEY_UNIT_INCA_CHASQUI_TEXT',	'TXT_KEY_UNIT_INCA_CHASQUI_STRATEGY',  	'TXT_KEY_UNIT_INCA_CHASQUI_HELP',	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_CHASQUI',	0,					'UNIT_INCA_FLAG_ATLAS',	0,				'UNIT_INCA_ATLAS',	MoveRate
...
INSERT INTO Unit_FreePromotions 	
			(UnitType, 					PromotionType)
VALUES		('UNIT_INCA_CHASQUI',		'PROMOTION_UNIT_INCA_KHIPU_RUNNER'),
			('UNIT_INCA_CHASQUI',		'PROMOTION_UNIT_INCA_CHASQUIWASI'),
...
VALUES		('PROMOTION_UNIT_INCA_KHIPU_RUNNER',	'TXT_KEY_PROMOTION_UNIT_INCA_KHIPU_RUNNER',		'TXT_KEY_PROMOTION_UNIT_INCA_KHIPU_RUNNER_HELP', 	'AS2D_IF_LEVELUP',	1, 					31, 			'PROMOTION_ATLAS', 	0, 					'PEDIA_SCOUTING',	'TXT_KEY_PROMOTION_UNIT_INCA_KHIPU_RUNNER'),
			('PROMOTION_UNIT_INCA_CHASQUIWASI',		'TXT_KEY_PROMOTION_UNIT_INCA_CHASQUIWASI',		'TXT_KEY_PROMOTION_UNIT_INCA_CHASQUIWASI_HELP', 	'AS2D_IF_LEVELUP',	1, 					37, 			'PROMOTION_ATLAS', 	0, 					'PEDIA_SCOUTING',	'TXT_KEY_PROMOTION_UNIT_INCA_CHASQUIWASI');
------------------------------
