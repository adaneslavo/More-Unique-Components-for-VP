...
VALUES		('IMPROVEMENT_SPAIN_HACIENDA',	'RESOURCE_AMBER',		'YIELD_GOLD',			2),
			...
			('IMPROVEMENT_SPAIN_HACIENDA',	'RESOURCE_HORSE',		'YIELD_PRODUCTION',		2),
			...
			('IMPROVEMENT_SPAIN_HACIENDA',	'RESOURCE_WINE',		'YIELD_PRODUCTION',		2),
			('IMPROVEMENT_SPAIN_HACIENDA',	'RESOURCE_WINE',		'YIELD_PRODUCTION',		2),
			('IMPROVEMENT_SPAIN_HACIENDA',	'RESOURCE_WINE',		'YIELD_PRODUCTION',		2),
			('IMPROVEMENT_SPAIN_HACIENDA',	'RESOURCE_WINE',		'YIELD_PRODUCTION',		2),
			('IMPROVEMENT_SPAIN_HACIENDA',	'RESOURCE_WINE',		'YIELD_PRODUCTION',		2),
			...
			('IMPROVEMENT_SPAIN_HACIENDA',	'RESOURCE_WHEAT',		'YIELD_FOOD',			2);
------------------------------
