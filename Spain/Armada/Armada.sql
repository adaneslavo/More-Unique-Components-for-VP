...
SELECT		'UNIT_SPAIN_ARMADA',	Class,	'TECH_GUNPOWDER',	Range,	BaseSightRange, Combat,	Cost+60,	FaithCost,	RequiresFaithPurchaseEnabled,	Moves-1,	Immobile, CombatClass, Domain, DefaultUnitAI,	'TECH_ROCKETRY',	GoodyHutUpgradeUnitClass,	XPValueAttack,	'TXT_KEY_UNIT_SPAIN_ARMADA',	'TXT_KEY_UNIT_SPAIN_ARMADA_TEXT',	'TXT_KEY_UNIT_SPAIN_ARMADA_STRATEGY',	'TXT_KEY_UNIT_SPAIN_ARMADA_HELP',	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AirUnitCap, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_SPAIN_ARMADA', 	0,					'UNIT_SPAIN_FLAG_ATLAS',	0, 				'UNIT_SPAIN_ATLAS',	MoveRate,	PurchaseCooldown
