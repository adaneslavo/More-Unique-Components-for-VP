...
VALUES		('PROMOTION_UNIT_SPAIN_SANTA_MARIA', 			'TXT_KEY_PROMOTION_UNIT_SPAIN_SANTA_MARIA',			'TXT_KEY_PROMOTION_UNIT_SPAIN_SANTA_MARIA_HELP', 			'AS2D_IF_LEVELUP',	0,				0,				0,			0,			0,					0,			0,					1, 				16, 			'PROMOTION_ATLAS', 					'PEDIA_NAVAL', 'TXT_KEY_PROMOTION_UNIT_SPAIN_SANTA_MARIA'),
			...
			('PROMOTION_UNIT_SPAIN_INVINCIBLE_AT_FULL', 	'TXT_KEY_PROMOTION_UNIT_SPAIN_INVINCIBLE_AT_FULL',	'TXT_KEY_PROMOTION_UNIT_SPAIN_INVINCIBLE_AT_FULL_HELP', 	'AS2D_IF_LEVELUP',	10,				0,				0,			0,			0,					0,			1,					1, 				0, 				'UNIT_BABYLON_PROMOTION_4_ATLAS', 	'PEDIA_NAVAL', 'TXT_KEY_PROMOTION_UNIT_SPAIN_INVINCIBLE_AT_FULL');
------------------------------
