...
VALUES
	('BUILDING_SPAIN_BULLRING', 'YIELD_YOURISM', 	4),
...
SELECT 'BUILDING_SPAIN_BULLRING', ResourceType, Cost
...
INSERT INTO Building_UnhappinessNeedsFlatReduction 	
			(BuildingType, YieldType, Yield)
SELECT 'BUILDING_SPAIN_BULLRING', YieldType, Yield
FROM Building_UnhappinessNeedsFlatReduction WHERE BuildingType = 'BUILDING_THEATRE';
