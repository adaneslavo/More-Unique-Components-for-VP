...
SELECT		'BUILDING_INDIA_QILA',	BuildingClass,	GoldMaintenance, Cost, FaithCost,	'TECH_FLIGHT',		TechEnhancedTourism, AllowsRangeStrike, Defense,	RangedStrikeModifier, ExtraCityHitPoints+25,	TrainedFreePromotion,	CitySupplyModifier,	CitySupplyFlat,	-25,					GreatPeopleRateModifier, GreatWorkSlotType, GreatWorkCount, FreshWater, FreeStartEra, Happiness, NeverCapture, PrereqTech, ArtDefineTag, GreatPeopleRateChange+1,	'SPECIALIST_ARTIST',	SpecialistCount, MinAreaSize, ConquestProb, HurryCostModifier,	'TXT_KEY_BUILDING_INDIA_QILA_HELP',	'TXT_KEY_BUILDING_INDIA_QILA',	'TXT_KEY_BUILDING_INDIA_QILA_TEXT',	'TXT_KEY_BUILDING_INDIA_QILA_STRATEGY',	'BW_ATLAS_1',	39
