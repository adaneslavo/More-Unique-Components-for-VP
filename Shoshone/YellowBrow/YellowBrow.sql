...
FROM ArtDefine_UnitMemberCombats WHERE UnitMemberType = 'ART_DEF_UNIT_U_ZULU_IMPI_WARRIOR';
------------------------------
...
FROM ArtDefine_UnitMemberCombatWeapons WHERE UnitMemberType = 'ART_DEF_UNIT_U_ZULU_IMPI_WARRIOR';
------------------------------
...
FROM ArtDefine_UnitMemberInfos WHERE Type = 'ART_DEF_UNIT_U_ZULU_IMPI_WARRIOR';
------------------------------
-- IconTextureAtlases
------------------------------
