...
VALUES		('UNIT_POLYNESIA_ATLAS', 			256, 		'KoaPicture_256.dds',	1, 				1),
			...
			('UNIT_POLYNESIA_PROMOTION_ATLAS',	16, 		'KapuKuialuaIcon_016.dds',	1, 				1),
			('UNIT_POLYNESIA_PROMOTION_ATLAS',	32, 		'KapuKuialuaIcon_032.dds',	1, 				1),
			('UNIT_POLYNESIA_PROMOTION_ATLAS',	45, 		'KapuKuialuaIcon_045.dds',	1, 				1),
			('UNIT_POLYNESIA_PROMOTION_ATLAS',	64, 		'KapuKuialuaIcon_064.dds',	1, 				1),
			('UNIT_POLYNESIA_PROMOTION_ATLAS',	256, 		'KapuKuialuaIcon_256.dds',	1, 				1);
--==========================================================================================================================	
...
VALUES		('PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA', 				'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA',				'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_HELP', 				'AS2D_IF_LEVELUP',	0,						0,				0,			0,			0,					0,			0,					1, 				0, 				'UNIT_POLYNESIA_PROMOTION_ATLAS', 	'PEDIA_SCOUTING',	'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA'),
			('PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_ON_UNIT', 		'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_ON_UNIT',		'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_ON_UNIT_HELP', 		'AS2D_IF_LEVELUP',	0,						0,				0,			0,			0,					0,			0,					1, 				57, 			'ABILITY_ATLAS', 					'PEDIA_SCOUTING',	'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_ON_UNIT'),
			('PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_2_ON_UNIT',		'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_2_ON_UNIT',		'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_2_ON_UNIT_HELP', 	'AS2D_IF_LEVELUP',	0,						0,				0,			0,			0,					0,			0,					1, 				57, 			'ABILITY_ATLAS', 					'PEDIA_SCOUTING',	'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_2_ON_UNIT'),
			('PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_3_ON_UNIT',		'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_3_ON_UNIT',		'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_3_ON_UNIT_HELP', 	'AS2D_IF_LEVELUP',	0,						0,				0,			0,			0,					0,			0,					1, 				57, 			'ABILITY_ATLAS', 					'PEDIA_SCOUTING',	'TXT_KEY_PROMOTION_UNIT_POLYNESIA_KAPU_KUIALUA_3_ON_UNIT');
--==========================================================================================================================	
...
SELECT		'UNIT_POLYNESIA_KOA',	Class,	PrereqTech,	Range,	BaseSightRange, Combat+2,	Cost,	FaithCost,	RequiresFaithPurchaseEnabled,	Moves, Immobile, CombatClass, Domain, DefaultUnitAI,	'TECH_STEAM_POWER',	GoodyHutUpgradeUnitClass,	XPValueAttack,	'TXT_KEY_UNIT_POLYNESIA_KOA',	'TXT_KEY_UNIT_POLYNESIA_KOA_TEXT',	'TXT_KEY_UNIT_POLYNESIA_KOA_STRATEGY',	'TXT_KEY_UNIT_POLYNESIA_KOA_HELP',	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AirUnitCap, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_POLYNESIA_KOA', 	0,					'UNIT_POLYNESIA_FLAG_ATLAS',	0, 				'UNIT_POLYNESIA_ATLAS',	MoveRate
