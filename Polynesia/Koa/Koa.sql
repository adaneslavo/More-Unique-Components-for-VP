...
SELECT		'UNIT_POLYNESIA_KOA',	Class,	PrereqTech,	Range,	BaseSightRange, Combat+4,	Cost,	FaithCost,	RequiresFaithPurchaseEnabled,	Moves, Immobile, CombatClass, Domain, DefaultUnitAI,	'TECH_STEAM_POWER',	GoodyHutUpgradeUnitClass,	XPValueAttack,	'TXT_KEY_UNIT_POLYNESIA_KOA',	'TXT_KEY_UNIT_POLYNESIA_KOA_TEXT',	'TXT_KEY_UNIT_POLYNESIA_KOA_STRATEGY',	'TXT_KEY_UNIT_POLYNESIA_KOA_HELP',	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AirUnitCap, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_POLYNESIA_KOA', 	0,					'UNIT_POLYNESIA_FLAG_ATLAS',	0, 				'UNIT_POLYNESIA_ATLAS',	MoveRate,	PurchaseCooldown
