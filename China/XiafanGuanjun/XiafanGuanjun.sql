...
SELECT		'UNIT_CHINA_XIAFAN_GUANJUN',	'TXT_KEY_UNIT_CHINA_XIAFAN_GUANJUN',	'TXT_KEY_UNIT_CHINA_XIAFAN_GUANJUN_TEXT',	'TXT_KEY_UNIT_CHINA_XIAFAN_GUANJUN_STRATEGY',	'TXT_KEY_UNIT_CHINA_XIAFAN_GUANJUN_HELP', 	Combat+6,	RangedCombat+2, Cost, FaithCost, RequiresFaithPurchaseEnabled, Moves, Range, BaseSightRange, Class, CombatClass, Domain,	DefaultUnitAI,  MilitarySupport, MilitaryProduction, Pillage, IgnoreBuildingDefense, Mechanized, 'TECH_ASTRONOMY',	'TECH_ELECTRONICS', GoodyHutUpgradeUnitClass, HurryCostModifier, AdvancedStartCost, MinAreaSize, Conscription, XPValueAttack, XPValueDefense, 'ART_DEF_UNIT_WARJUNK', 	0,					0,				'UNIT_CHINA_ATLAS',	'UNIT_CHINA_FLAG_ATLAS',	MoveRate, PurchaseCooldown, BaseLandAirDefense, IsMounted
