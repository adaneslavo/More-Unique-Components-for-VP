...
SELECT		'UNIT_CHINA_XIAFAN_GUANJUN',	'TXT_KEY_UNIT_CHINA_XIAFAN_GUANJUN',	'TXT_KEY_UNIT_CHINA_XIAFAN_GUANJUN_TEXT',	'TXT_KEY_UNIT_CHINA_XIAFAN_GUANJUN_STRATEGY',	'TXT_KEY_UNIT_CHINA_XIAFAN_GUANJUN_HELP', 	Combat+8,	RangedCombat+2, Cost, FaithCost, RequiresFaithPurchaseEnabled, Moves, Range, BaseSightRange, Class, CombatClass, Domain,	DefaultUnitAI,  MilitarySupport, MilitaryProduction, Pillage, IgnoreBuildingDefense, Mechanized, 'TECH_ASTRONOMY',	'TECH_ELECTRONICS', GoodyHutUpgradeUnitClass, HurryCostModifier, AdvancedStartCost, MinAreaSize, Conscription, XPValueAttack, XPValueDefense, 'ART_DEF_UNIT_WARJUNK', 	0,					0,				'UNIT_CHINA_ATLAS',	'UNIT_CHINA_FLAG_ATLAS',	MoveRate, PurchaseCooldown, BaseLandAirDefense, IsMounted
...
VALUES			('UNIT_CHINA_XIAFAN_GUANJUN',	'PROMOTION_UNIT_CHINA_KOWTOW'),
				('UNIT_CHINA_XIAFAN_GUANJUN',	'PROMOTION_BOMBARDMENT_4');
--==========================================================================================================================	
...
INSERT INTO ArtDefine_UnitMemberInfos (Type, Scale, ZOffset, Domain, Model, MaterialTypeTag, MaterialTypeSoundOverrideTag)
	SELECT	('ART_DEF_UNIT_MEMBER_WARJUNK'), '0.1', ZOffset, Domain, ('WarJunk.fxsxml'), MaterialTypeTag, MaterialTypeSoundOverrideTag
